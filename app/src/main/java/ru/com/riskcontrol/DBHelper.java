...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table registries (_id integer primary key, factory_id integer, model integer,scale text, date_of_creation text)");
        ...
        db.execSQL("create table minimization_measure (_id integer primary key, risk_id integer, name text, responsible text, date text, date_of_creation text)");
    }
