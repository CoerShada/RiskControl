...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table risks (_id integer primary key, name text, riks_type_id integer, probability real, detection_probability real, severity_of_consequences real, significance real, priority real)");
