...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table risks (_id integer primary key, name text, risk_type_id integer, probability_of_occurrence real, detection_probability_estimate real, severity_assessment real, magnitude_of_risk real)");
